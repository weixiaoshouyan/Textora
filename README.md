...
| 阶段 | 状态 | 内容 |
|---|---|---|
| 1 | ✅ 已完成 | 最小可用编辑器：Tauri 脚手架、Milkdown 集成、基础 Markdown、文件打开/保存、明暗主题、快捷键、字数统计、最近文件 |
...
```bash
npm run build    # tsc 编译主进程 + Vite 构建渲染进程 + electron-builder 生成 Windows NSIS 安装包
```
...
│   ├── hooks/                     # useShortcuts / useTauriMenu / shortcutSchema
│   └── ai/                        # aiService / config
